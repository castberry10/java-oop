 ...
 * 이리저리 걸어다닐 수 있다. 이 버전에서는 그게 다다. 앞으로 더 흥미로운 게임으로 발전시겨 볼 것이다.
 * 
 * 이 클래스는 다른 클래스 객체들을 구성하고 그것들을 초기화시켜 준다. 방들과 parser를 만들고 게임을 시작한다. 이 클래스는
 * parser가 반환하는 명령을 해석하고 실행한다.
 * 
